...
import net.shinyyssoda.procedures.BlueVMBottomBlockIsPlacedByProcedure;
...
public class BlueVMBottomBlock extends SodaModElements.ModElement {
	@ObjectHolder("soda:blue_vm_bottom")
	public static final Block block = null;
	public BlueVMBottomBlock(SodaModElements instance) {
		super(instance, 201);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("blue_vm_bottom");
		}
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				BlueVMBottomBlockIsPlacedByProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
