...
public class UnrefinedSteeloreBlock extends SodaModElements.ModElement {
	@ObjectHolder("soda:unrefinedsteelore")
	public static final Block block = null;
	public UnrefinedSteeloreBlock(SodaModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("unrefinedsteelore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(UnrefinedSteelIngotItem.block, (int) (3)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("unrefinedsteelore", "unrefinedsteelore", blockAt -> {
