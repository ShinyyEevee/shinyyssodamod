...
public class DirtSodaCanItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:dirt_soda_can")
	public static final Item block = null;
	public DirtSodaCanItem(SodaModElements instance) {
		super(instance, 107);
	}
