...
public class WolfSodaCanItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:wolf_soda_can")
	public static final Item block = null;
	public WolfSodaCanItem(SodaModElements instance) {
		super(instance, 111);
	}
