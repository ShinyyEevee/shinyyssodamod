...
public class SpookySodaCanItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:spooky_soda_can")
	public static final Item block = null;
	public SpookySodaCanItem(SodaModElements instance) {
		super(instance, 185);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("spooky_soda_can");
		}
