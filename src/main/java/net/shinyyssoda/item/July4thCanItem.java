...
public class July4thCanItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:july_4th_can")
	public static final Item block = null;
	public July4thCanItem(SodaModElements instance) {
		super(instance, 208);
	}
