...
public class KickStartItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:kick_start")
	public static final Item block = null;
	public KickStartItem(SodaModElements instance) {
		super(instance, 173);
	}
