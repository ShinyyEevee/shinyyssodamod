...
public class GameFuelRedItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:game_fuel_red")
	public static final Item block = null;
	public GameFuelRedItem(SodaModElements instance) {
		super(instance, 174);
	}
