...
public class SteelIngotItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:steelingot")
	public static final Item block = null;
	public SteelIngotItem(SodaModElements instance) {
		super(instance, 19);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Oh look steel."));
		}
	}
}
