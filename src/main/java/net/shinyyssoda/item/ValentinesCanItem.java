...
public class ValentinesCanItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:valentines_can")
	public static final Item block = null;
	public ValentinesCanItem(SodaModElements instance) {
		super(instance, 204);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("valentines_can");
		}
