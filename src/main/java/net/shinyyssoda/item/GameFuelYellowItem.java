...
public class GameFuelYellowItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:game_fuel_yellow")
	public static final Item block = null;
	public GameFuelYellowItem(SodaModElements instance) {
		super(instance, 176);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("game_fuel_yellow");
		}
