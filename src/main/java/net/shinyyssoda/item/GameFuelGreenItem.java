...
public class GameFuelGreenItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:game_fuel_green")
	public static final Item block = null;
	public GameFuelGreenItem(SodaModElements instance) {
		super(instance, 175);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("game_fuel_green");
		}
