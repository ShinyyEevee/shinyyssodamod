...
public class PepsiItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:pepsi")
	public static final Item block = null;
	public PepsiItem(SodaModElements instance) {
		super(instance, 24);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Classic Pepsi Flavor"));
		}
