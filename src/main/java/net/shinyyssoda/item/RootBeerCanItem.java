...
public class RootBeerCanItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:root_beer_can")
	public static final Item block = null;
	public RootBeerCanItem(SodaModElements instance) {
		super(instance, 135);
	}
