...
public class MonsterItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:monster")
	public static final Item block = null;
	public MonsterItem(SodaModElements instance) {
		super(instance, 159);
	}
