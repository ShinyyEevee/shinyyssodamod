...
public class GoldCanItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:gold_can")
	public static final Item block = null;
	public GoldCanItem(SodaModElements instance) {
		super(instance, 139);
	}
