...
import net.shinyyssoda.procedures.MangoPepsiItemIsCraftedsmeltedProcedure;
...
public class MangoPepsiItem extends SodaModElements.ModElement {
	@ObjectHolder("soda:mangopepsi")
	public static final Item block = null;
	public MangoPepsiItem(SodaModElements instance) {
		super(instance, 48);
	}
